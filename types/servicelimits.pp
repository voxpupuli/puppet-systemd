...
type Systemd::ServiceLimits = Struct[
  {
    ...
    Optional['MemoryLow']           => Pattern['^(infinity|((\d+(K|M|G|T|%)(:\d+(K|M|G|T|%))?)))$'],
    Optional['MemoryMin']           => Pattern['^(infinity|((\d+(K|M|G|T|%)(:\d+(K|M|G|T|%))?)))$'],
    Optional['MemoryHigh']          => Pattern['^(infinity|((\d+(K|M|G|T|%)(:\d+(K|M|G|T|%))?)))$'],
    Optional['MemoryMax']           => Pattern['^(infinity|((\d+(K|M|G|T|%)(:\d+(K|M|G|T|%))?)))$'],
    Optional['MemoryLimit']         => Pattern['^(infinity|((\d+(K|M|G|T|%)(:\d+(K|M|G|T|%))?)))$'],
